...
*******************************
Script Purpose:
The following stored procedure loads data into the bronze schema from CSV files. 
It truncates the bronze schema tables before loading the data 
It uses the bulk insert command to load data into all the tables
Additionaly, there is error handling and duration tracking 
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '>> INsertingData Into: bronze.erp_cust_az12'
